...
if __name__ == '__main__':
	...
	# }
	dat={"token":"00001f7f0000542e00001d3200006c62", "uitype": "1", "ext": "5222"}
	print(dat)
	result=run.run_main(method=geta,url='https://localhost:3001/pcapi/v1/accessed/showui',data=dat)
	print(type(geta))
	print(type(result))
	print(result.text)
	print(result.url)
